...
export default function App() {
  ...
  const handleColorDominanceDetected = (
    dominantColor: string,
    allColors?: Array<{ color: string; percentage: number }>
  ) => {
    if (
      customSettings.colorDominance.enabled &&
      customSettings.colorDominance.targetColor !== dominantColor
    ) {
      setCustomSettings((s) => ({
        ...s,
        colorDominance: {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-neutral-100 font-sans">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {/* Main Item */}
        <div
          className="relative z-10 w-full flex items-center justify-center p-8 transition-all"
          style={{ height: "60vh" }}
        >
